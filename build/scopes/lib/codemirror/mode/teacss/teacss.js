CodeMirror.defineMode("teacss", function(config, parserConfig) {
    ...
    function test_teacss() {
        if (!teacss.LexerStack) {
            if (!teacss) window.teacss = {};
            window.teacss.LexerStack = (function(){
                function LexerStack() {
                    this.states = [];
        ...
        token: function(stream, stack) {
            ...
            switch (stack.state) {
                case "scope":
                    ...
                    if (stream.match("@ ")) { stack.push("js_line"); return 'js_line_start'; }
                ...
                case "js_line":
                    ...
                    return jsMode.token(stream, stack.jsState);
                case "js_block":
                ...
                case "rule":
                    ...
                    if (stack.data.string_single) {
                        ...
                        if (stream.peek()=="'") { stack.data.string_single = true; stream.next(); return "string"; }
                            ...
                            var tags_re = /^(html|head|body|title|div|ul|li|b|strong|i|font|a|h1|h2|h3|h4|h5|h6|script|style|form|input|button|label|p)[\[\s{;}\.#]/;
